...
//----------------------------------
function openExportRapportOverlay() {
//----------------------------------
...
//----------------------------------
    ...
    terminAuswahl.removeEventListener("change", updateTagesrpport);
    terminAuswahl.addEventListener("change", updateTagesrpport);
}

//----------------------------------
function updateTagesrpport() {
//----------------------------------
    const terminAuswahl = document.getElementById("tagesrapportTerminAuswahl");
    const ausgewaehlterTermin = terminAuswahl.value;
    aktTermin = terminAuswahl.value;
    console.log("-----updateTagesrpport--->  ", aktTermin);
...
//----------------------------------
function xxxfülleRapportTabelle (meldungen, tbody, titel) {
//----------------------------------
    const titlerow = document.createElement("tr");
    titlerow.innerHTML = `<td>${titel}</td>`;
    tbody.appendChild(titlerow);
...
//console.log("Rapport erfolgreich erstellt:", response);
        updateExportStatus ('rapportStatusContainer', "Tagesrapport wurde erstellt...", false); 
    ...
    .catch(error => {
        updateExportStatus ('rapportStatusContainer', "Fehler beim Erstellen des Rapports:", false); 
