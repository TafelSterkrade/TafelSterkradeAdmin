...
// ----------------------------------
  ...
  if (terminAuswahl && verfuegbareTermine.length > 0) {
    ...
    const terminSpaltenUeberschrift = document.querySelector('#tabellen-bereich th:nth-child(2)');
...
// ----------------------------------
  const abbrechenSpeichernButton = document.getElementById('abbrechenSpeichern');
  const bestaetigenSpeichernButton = document.getElementById('bestaetigenSpeichern');
  const aenderungsProtokollOverlay = document.getElementById('aenderungsProtokollOverlay');
